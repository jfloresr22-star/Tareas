...
public class GeneradorClientes {
    ...
    public static void generarArchivo(String ruta,
        ...
        try {
            ...
            for (int i = 1; i <= cantidad; i++) {
                ...
                double ingreso =
                        generarIngreso(random);

                String segmento =
                        segmentos[random.nextInt(segmentos.length)];
    ...
    public static double generarIngreso(Random random) {
    ...
    public static String generarJsonPesado(Random random) {
        ...
        sb.append("\"observacion\":\"JSON pesado\"");
